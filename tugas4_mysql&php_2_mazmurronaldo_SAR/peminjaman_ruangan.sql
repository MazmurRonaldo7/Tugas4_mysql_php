...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3855923370ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tabel terakhir" class="drop_button btn">Terbaru</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=peminjaman_ruangan&table=kategori_ruangan">`peminjaman_ruangan`.`kategori_ruangan`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=peminjaman_ruangan&table=gedung">`peminjaman_ruangan`.`gedung`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=peminjaman_ruangan&table=fasilitas">`peminjaman_ruangan`.`fasilitas`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_jne&table=tb_jne1">`db_jne`.`tb_jne1`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbpenjadwalan&table=profile">`dbpenjadwalan`.`profile`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbpenjadwalan&table=detail_jadwal">`dbpenjadwalan`.`detail_jadwal`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbpenjadwalan&table=jeniskelas">`dbpenjadwalan`.`jeniskelas`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbpenjadwalan&table=user">`dbpenjadwalan`.`user`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbpenjadwalan&table=klien">`dbpenjadwalan`.`klien`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=dbpenjadwalan&table=kategori">`dbpenjadwalan`.`kategori`</a></li></ul></div><div class="drop_list"><button title="Tabel favorit" class="drop_button btn">Favorit</button><ul id="pma_favorite_list"><li class="warp_link">Tidak ada tabel favorit terbaru.</li></ul></div><div class="clearfloat"></div></div>
